...
class ReservationRepositoryTest {
    ...
    void getReservationsForClientTest() {
        ...
        Client c1 = new Client("pb98", "sekret", "Pawel", "Bialek", new NormalClient());
        Client c2 = new Client("lk98", "sekret", "Lukasz", "Kostrzewa", new NormalClient());
    ...
    void getReservationsForResourceTest() {
        ...
        Client c1 = new Client("pb98", "sekret","Pawel", "Bialek", new NormalClient());
        Client c2 = new Client("lk98", "sekret", "Lukasz", "Kostrzewa", new NormalClient());
        Client c3 = new Client("am77", "sekret", "Adam", "Malysz", new PremiumClient());
